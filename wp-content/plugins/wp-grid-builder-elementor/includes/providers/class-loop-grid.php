 ...
 * Posts widget
 *
 * @class WP_Grid_Builder_Elementor\Includes\Providers\Loop_Grid
 * @since 1.0.0
 */
final class Loop_Grid extends Base {
	...
	public function get_options() {
		...
		return [
			'itemSelector' => '.elementor-loop-container > *',
	...
	public function no_results( $query, $widget ) {
		...
		echo '<div class="elementor-loop-container elementor-grid">' . wp_kses_post( $widget->get_settings( 'wpgb_noresults' ) ) . '</div>';
